...
import { formatPercent, type FundRanking } from "@/lib/cef-universe"
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="border-border bg-card">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm text-foreground">Z-Score + PSI Composite Ranking</CardTitle>
            <CardDescription>Higher score = better risk-adjusted opportunity</CardDescription>
          </CardHeader>
          <CardContent>
