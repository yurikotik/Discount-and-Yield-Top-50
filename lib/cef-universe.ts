...
// ─── Seeded PRNG (deterministic across server/client to avoid hydration mismatch)
let _seed = 42
...
// Reset seed before generating fund profiles to ensure identical output on server/client
_seed = 42
